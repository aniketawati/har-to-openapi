...
export type InternalConfig = WithRequired<HarToOpenAPIConfig, "filterStandardHeaders" | "addServersToPaths" | "attemptToParameterizeUrl" | "minLengthForNumericPath" | "relaxedMethods" | "guessAuthenticationHeaders" | "dropPathsWithoutSuccessfulResponse" | "relaxedContentTypeJsonParse" | "forceAllRequestsInSameSpec">;
